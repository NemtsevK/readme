            ...
            <div class="popular__filters filters">
                ...
                <ul class="popular__filters-list filters__list">
                    <li class="popular__filters-item filters__item filters__item--all popular__filters-item--all">
                        <a class="filters__button filters__button--ellipse filters__button--all<?= $categ_chosen === 0 ? ' filters__button--active' : ''; ?>" href="<?= $ROOT_DIRECTORY; ?>">
                            <span>Все</span>
                        </a>
                    </li>
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="images/<?= $post['avatar']; ?>" alt="Аватар пользователя">
                            </div>
